...
<center>
  ...
  <br>
  <font color="white">
  <h3>How Much Quantity To Add?</h3>
  <input name="txtvalue" type="text" placeholder="Enter updated quantity here">
  <br><br>
  <input type="submit" name="subs" value="Click to Add Quantity To Your Stock"><br>
  <a href="signup2.php"><input type="button" value="Add New Medicine Instead? Click Here"><a href="view.php"><input type="button" value="Watch Your Stock First"></a></a>
 </font>
  <?php
  		if(!empty($error))
  		{
